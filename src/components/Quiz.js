        ...
        <div className="contant-div">
          ...
          <form>
            {questions[currentQuestion].options.map((option, index) => (
              <div key={index}>
                <input style={{ marginRight: "10px" }} type="radio" id={`option_${index}`} name={`question_${currentQuestion}`} value={index} defaultChecked={false} onChange={() => handleResponseChange(index)} />
